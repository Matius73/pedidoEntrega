...
try:
    conn = mysql.connector.connect(
           host='Matius.mysql.pythonanywhere-services.com',
           user='Matius',
           password='mysqlroot'
      )
...
cursor.execute("DROP DATABASE IF EXISTS `Matius$pedidoEntrega`;")

cursor.execute("CREATE DATABASE `Matius$pedidoEntrega`;")

cursor.execute("USE `Matius$pedidoEntrega`;")
...
cursor.execute('select * from Matius$pedidoEntrega.usuarios')
print(' -------------  Usuarios:  -------------')
...
cursor.execute('select * from Matius$pedidoEntrega.productos')
print(' -------------  Productoss:  -------------')
